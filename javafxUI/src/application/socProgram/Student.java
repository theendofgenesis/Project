...
public class Student {
	...
	public Student(String name, int jnumber,int expectedgraddate, String focus, Boolean summerclasses, String[] completedcourses, String[] nexttermcourses) {
	...
	public int setJnumber(int jnumber) {
